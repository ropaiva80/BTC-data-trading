...
call "C:\Users\ropai\anaconda3\Scripts\activate.bat" Python3.8.13_Env-GluonTS_on_1h_FastParallel & cd "C:\Python\Crypto\Script2\Scratch\BTC\1H_Close" & python Script2_BTC_COINBASE_HOURLY-Autots_GluonTS-1H_ON_FastParallel-90D.py