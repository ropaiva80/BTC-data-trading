...
call "C:\Users\ropai\anaconda3\Scripts\activate.bat" Python3.8_Env-GluonTS_on_1h_simple & cd "C:\Python\Crypto\Script2\Scratch\BTC\1H_Close" & python Script2_BTC_COINBASE_HOURLY-Autots_GluonTS-1H_ON_Simple-5D.py