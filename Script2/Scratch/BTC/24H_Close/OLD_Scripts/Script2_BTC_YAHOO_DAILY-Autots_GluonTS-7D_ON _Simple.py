...
for index, row in df.iterrows():
    cursor.execute("INSERT INTO BITCOIN_v2_YAHOOFINANCE (DATETIME_PREDICTION,PRICE_PREDICTION,ASSET_NAME,ALGORITHMS,CATEGORY) values(?,?,'BTC','AUTOTS_GLUONTS-ON_7D_Yahoo_Simple','DAILY')", row.Date, row.Close)
    cnxn.commit()
cursor.close()
