...
for index, row in df.iterrows():
	cursor.execute("INSERT INTO BITCOIN_v1_COINBASE (DATETIME_PREDICTION,PRICE_PREDICTION,ASSET_NAME,ALGORITHMS,CATEGORY) values(?,?,'BTC','AAG-on_CB-S-DAILY-21D','DAILY')", row.time, row.close)
cnxn.commit()
cursor.close()