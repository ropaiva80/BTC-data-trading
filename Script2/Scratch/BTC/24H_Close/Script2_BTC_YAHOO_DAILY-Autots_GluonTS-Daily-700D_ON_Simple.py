...
for index, row in df.iterrows():
    cursor.execute("INSERT INTO BITCOIN_v2_YAHOOFINANCE (DATETIME_PREDICTION,PRICE_PREDICTION,ASSET_NAME,ALGORITHMS,CATEGORY) values(?,?,'BTC','DAG-on_YH-S-DAILY-700D','DAILY')", row.Date, row.Close)
cnxn.commit()
cursor.close()