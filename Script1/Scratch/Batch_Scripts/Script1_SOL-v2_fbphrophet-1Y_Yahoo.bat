...
call "C:\Users\ropai\anaconda3\Scripts\activate.bat" Python3.8_Env-GluonTS_on_1h_simple & cd "C:\Python\Crypto\Script1\Scratch" & python Script1_SOL-v2_fbphrophet-1Y.py